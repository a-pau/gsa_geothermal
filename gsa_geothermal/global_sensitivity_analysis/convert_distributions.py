...
def convert_sample_to_truncated_triang(parameters, sample):
    ...
    q_low_t = stats.triang.cdf(
        parameters["minimum"], c=parameters["shape"], loc=parameters["loc"], scale=parameters["scale"]
    )
    q_high_t = stats.triang.cdf(
        parameters["maximum"], c=parameters["shape"], loc=parameters["loc"], scale=parameters["scale"]
    )
