...
cge_F = pd.read_excel(
    os.path.join(
        absolute_path, "generated_files/gsa_results/cge_N500/sobol_first.xlsx"
    ),
    usecols=col,
)
cge_T = pd.read_excel(
    os.path.join(
        absolute_path, "generated_files/gsa_results/cge_N500/sobol_total.xlsx"
    ),
    usecols=col,
)
ege_F = pd.read_excel(
    os.path.join(
        absolute_path, "generated_files/gsa_results/ege_N500/sobol_first.xlsx"
    ),
    usecols=col,
)
ege_T = pd.read_excel(
    os.path.join(
        absolute_path, "generated_files/gsa_results/ege_N500/sobol_total.xlsx"
    ),
    usecols=col,
)
