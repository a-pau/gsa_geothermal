...
class GeothermalEnhancedModel:
    ...
    def model(self, parameters):
        ...
        number_of_wells = parameters["number_of_wells"] + (self.number_of_expl_wells * self.equivalency_expl_to_normal_wells)
        
        number_of_wells_drilled = (np.ceil(parameters["number_of_wells"] / success_rate_primary_wells) +
