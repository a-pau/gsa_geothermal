...
# This model does not consider any type of rounding or ceiling that is used 
# e.g. for estimating the number of wells.
# It was developed when the reference and the simplified models were giving different results,
# But it is no long used. 
...
class GeothermalConventionalModel:
    ...
    def model(self, params):
        ...
        number_of_production_wells = (params["installed_capacity"] / 
                                       params["gross_power_per_well"]) 
        
        number_of_injection_wells  = number_of_production_wells / params["production_to_injection_ratio"]
        
        number_of_makeup_wells     = number_of_production_wells * params["initial_harmonic_decline_rate"] * \
                                     params["lifetime"]
        ...
        number_of_wells_drilled    = (number_of_production_wells + number_of_injection_wells)/ success_rate_primary_wells + \
                                     (number_of_makeup_wells / success_rate_makeup_wells) + \
                                     (self.number_of_expl_wells / success_rate_exploration_wells) * self.equivalency_expl_to_normal_wells
