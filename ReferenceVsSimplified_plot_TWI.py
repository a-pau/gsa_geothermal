...
cge_parityplot_col.text(0.5, 0.01, 'Full model', ha='center', fontsize=12, fontweight="bold")
...
for i, method in enumerate(ILCD):
    ...
    ax_.set_title(label=title_, fontsize=9)
    ax_.set(xlabel="", ylabel="")
ege_parityplot_col.text(0.5, 0.01, 'Full model', ha='center', fontsize=12, fontweight="bold")
