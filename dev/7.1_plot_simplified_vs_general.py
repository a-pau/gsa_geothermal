...
if __name__ == '__main__':
    ...
    filename_conventional_scores = "{}.general_model.climate_change.N{}.json".format("conventional", iterations)
    filepath_conventional_scores = write_dir / filename_conventional_scores
    filename_enhanced_scores = "{}.general_model.climate_change.N{}.json".format("enhanced", iterations)

    # Set project
    bw.projects.set_current("Geothermal")

    # Methods
    ILCD, ILCD_units = get_EF_methods(units=True)
