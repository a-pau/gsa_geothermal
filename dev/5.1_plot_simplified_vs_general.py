...
if __name__ == '__main__':
    ...
    filename_conventional_simplified = "{}.{}.all_categories.N{}.threshold{}.json".format("conventional", "simplified", iterations, threshold_cge)
    filename_enhanced_simplified = "{}.{}.all_categories.N{}.threshold{}.json".format("enhanced", "simplified", iterations, threshold_ege)
    ...
    cge_s_df = pd.read_json(filepath_conventional_simplified).melt(var_name="method", value_name="simplified")
    ege_s_df = pd.read_json(filepath_enhanced_simplified).melt(var_name="method", value_name="simplified")
    ...
    for i, method in enumerate(methods):
        ...
        plt.scatter(x=df_sort.general, y=df_sort.simplified, s=7, c=kde_v_sort, cmap="cool", linewidth=0)
    ...
    # save plots
    filename_cge_plot = "parity_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("conventional", iterations, threshold_cge)
    ...
    # Save figures plots
    filename_ege_plot= "parity_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("enhanced", iterations, threshold_cge)  
    ...
    # save plots
    filename_cge_plot_b = "box_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("conventional", iterations, threshold_cge)
    ...
    filename_ege_plot_b = "box_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("enhanced", iterations, threshold_cge)
    ...
    # save plot
    filename_cge_plot_v = "violin_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("conventional", iterations, threshold_cge)
    ...
    filename_ege_plot_v = "violin_plot.simplified_vs_general.{}.N{}.threshold{}.tiff".format("enhanced", iterations, threshold_cge)
