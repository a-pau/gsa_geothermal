...
if __name__ == "__main__":
    ...
    for threshold in thresholds:
        ...
        cge_df[threshold] = pd.concat([cge_gen_df, cge_s_df["simplified"]], axis=1)
        ege_df[threshold] = pd.concat([ege_gen_df, ege_s_df["simplified"]], axis=1)
    ...
    for threshold in thresholds:
        ...
        for i, method in enumerate(methods):
            ...
            df = cge_df[threshold][cge_df[threshold].method == method[1]]
        ...
        cge_parityplot_col.suptitle(
            "CONVENTIONAL, THRESHOLD=" + "{:.0%}".format(threshold), fontsize=13
            )
        ...
        # save plot
        filename_cge_plot = (
            "parity_plot.simplified_t{:02d}_vs_general.{}.N{}.seed{}.tiff".format(
                int(threshold*100), "conventional", iterations, seed,
            )
        )
        filepath_cge_plot = write_dir_figures / filename_cge_plot
    ...
    for threshold in thresholds:
        ...
        for i, method in enumerate(methods):
            ...
            df = ege_df[threshold][ege_df[threshold].method == method[1]]
        ...
        ege_parityplot_col.suptitle(
            "ENHANCED, THRESHOLD=" + "{:.0%}".format(threshold), fontsize=13
        )      
        ...
        filename_ege_plot = (
            "parity_plot.simplified_t{:02d}_vs_general.{}.N{}.seed{}.tiff".format(
                int(threshold*100), "enhanced", iterations, seed
                )
        )
        filepath_ege_plot = write_dir_figures / filename_ege_plot
    ...
    #     ax.set(xlabel="", title=methods[counter][1])
    ...
    #     )
    # )
    # filepath_cge_plot_b = write_dir_figures / filename_cge_plot_b
    ...
    #     )
    # )
    # filepath_ege_plot_b = write_dir_figures / filename_ege_plot_b
    ...
    #     )
    # )
    # filepath_cge_plot_v = write_dir_figures / filename_cge_plot_v
    ...
    #     )
    # )
    # filepath_ege_plot_v = write_dir_figures / filename_ege_plot_v
