...
def run_mc(parameters, demand , methods, n_iter):
    ...
    for method in methods:
        ...
        for i in range(n_iter):
            ...
            scores_m[i]=replace_and_compute(lca, CF_matr, method, where_tech, amt_tech, where_bio, amt_bio,i)
            
        scores[method]=scores_m
        
    return scores

def run_mc_dask(parameters, demand , methods, n_iter):
    ...
    for method in methods:
        ...
        dask.compute(*scores_m)
        #scores[method]=interim_
